  ...
  return (
    ...
    >
      <body className="flex flex-col min-h-screen bg-background text-foreground font-sans antialiased">
        ...
        {/* Footer */}
        <footer className="mt-auto bg-background/80 backdrop-blur-sm border-t border-border/50">
          <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 pt-8 border-t border-border/50">
              <p className="text-center text-sm text-foreground-secondary">
                © {new Date().getFullYear()} Next.js Template. Built with Next.js, TypeScript, and Three.js.
              </p>
            </div>
          </div>
        </footer>
